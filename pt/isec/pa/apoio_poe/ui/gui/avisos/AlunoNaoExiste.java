...
public class AlunoNaoExiste extends BorderPane {
    GridPane grid;
    ...
    public AlunoNaoExiste(apoio_poeContext context) {
    ...
    private void createViews(){
        ...
        labelInfo = new Label("");
        labelInfo.setText("The student you are trying to edit doesn't exist");
