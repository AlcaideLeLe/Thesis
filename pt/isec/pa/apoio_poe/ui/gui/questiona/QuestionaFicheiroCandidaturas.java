...
public class QuestionaFicheiroCandidaturas extends BorderPane {
    ...
    public QuestionaFicheiroCandidaturas(apoio_poeContext context) {
        super();
    ...
    private void registerHandlers(){
        buttonConfirm.setOnAction(ev->{
            context.exportarCandidaturasParaCSV(textFile.getText());
