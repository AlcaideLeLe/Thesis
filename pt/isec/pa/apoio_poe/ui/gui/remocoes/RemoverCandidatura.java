...
public class RemoverCandidatura extends BorderPane {
    ...
    public RemoverCandidatura(apoio_poeContext context) {
        super();
        ...
        buttonConfirm.setOnAction(ev-> {
                    ...
                    for (int i = 0; i < context.consultarAlunos().size(); i++) {
                        if (context.consultarAlunos().get(i).getNumero() == Long.parseLong(textNr.getText())) {
                            context.removerCandidatura(Long.parseLong(textNr.getText()));
