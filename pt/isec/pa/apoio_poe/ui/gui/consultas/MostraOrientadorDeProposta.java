...
public class MostraOrientadorDeProposta extends BorderPane {
    apoio_poeContext context;
    String ID;

    public MostraOrientadorDeProposta(apoio_poeContext context, String ID) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarOrientadorDeProposta(ID));
