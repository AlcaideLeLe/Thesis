...
public class MostraAlunosComPropostaESemOrientador extends BorderPane {
    apoio_poeContext context;

    public MostraAlunosComPropostaESemOrientador(apoio_poeContext context) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarAlunosComPropostaESemOrientador());
