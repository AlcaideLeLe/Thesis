...
public class MostraProposta extends BorderPane {
    apoio_poeContext context;
    String id;
    public MostraProposta(apoio_poeContext context, String id) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultaProposta(id));
