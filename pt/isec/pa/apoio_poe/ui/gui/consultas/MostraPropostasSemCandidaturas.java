...
public class MostraPropostasSemCandidaturas extends BorderPane {
    apoio_poeContext context;

    public MostraPropostasSemCandidaturas(apoio_poeContext context) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarPropostasSemCandidaturas());
