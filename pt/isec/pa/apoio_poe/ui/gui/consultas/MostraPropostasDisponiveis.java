...
public class MostraPropostasDisponiveis extends BorderPane {
    apoio_poeContext context;

    public MostraPropostasDisponiveis(apoio_poeContext context) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarPropostasDisponiveis());
