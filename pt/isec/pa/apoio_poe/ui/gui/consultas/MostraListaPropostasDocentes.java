...
public class MostraListaPropostasDocentes extends BorderPane {
    apoio_poeContext context;

    public MostraListaPropostasDocentes(apoio_poeContext context) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarPropostasDocentes());
