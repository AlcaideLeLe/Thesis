...
public class MostraPropostasComCandidaturas extends BorderPane {
    apoio_poeContext context;

    public MostraPropostasComCandidaturas(apoio_poeContext context) {
    ...
    public void createViews(){
        ...
        tableView.getItems().addAll(context.consultarPropostasComCandidaturas());
